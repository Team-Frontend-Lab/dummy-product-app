# Frontend Lab - Dummy Product App

![Design preview for the Dummy Product App frontend assessment](./preview.png)
...
Your challenge is to build a Dummy Product App using React.
...
- Implement search functionality to allow users to find products by title
- Implement pagination to list per page 10 product
- Use the dummy product API: [Products API](https://dummyjson.com/products)
